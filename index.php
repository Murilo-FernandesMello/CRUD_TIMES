                                       ...
                                       foreach($query_run as $time)    {
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <a href="time-view.php?idTime=<?= $time['idTime']; ?>" class="btn btn-info btn-sm">Visualizar</a>
                                                   <a href="time-edit.php?idTime=<?= $time['idTime']; ?>" class="btn btn-success btn-sm">Editar</a>
                                                   <form action="code.php" method="POST" class="d-inline">
                                                       <button type="submit" name="delete_time" value="<?=$time['idTime'];?>" class="btn btn-danger btn-sm">Deletar</button>
                                                   </form>
                                               </td>
                                           </tr>
                                           <?php
